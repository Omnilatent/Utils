...
public class CanvasSafeAreaResizer : MonoBehaviour
{
    private static List<CanvasSafeAreaResizer> helpers = new List<CanvasSafeAreaResizer>();
    ...
    private void Reset()
    {
        ...
        if (childTransform != null)
            safeAreaTransform = childTransform.GetComponent<RectTransform>();
    }
}